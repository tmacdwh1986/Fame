...
public class AcceleratorController {
	...
	// @GetMapping("accel/{city}")
	// public RestResponse statAcceleratorRange(@PathVariable(value = "city")
	// String city) {
	@GetMapping("accel")
	public RestResponse statAcceleratorRange() {
		String city = "All";
		List<Map<String, Object>> retList = new ArrayList<Map<String, Object>>();
		String[] xAxis = new String[] { "T<10%", "10%=<T<20%", "20%=<T<30%", "30%=<T<40%", "40%=<T<50%'", "50%=<T<60%",
				"60%=<T<70%", "70%=<T<80%", "80%=<T<90%", "90%=<T<100%", "T>=100%" };
